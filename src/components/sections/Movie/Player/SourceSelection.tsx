              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-1">
                    {recommended && <Star className={cn("size-3", isSelected ? "text-primary-foreground" : "text-warning")} />}
                    {fast && <Rocket className={cn("size-3", isSelected ? "text-primary-foreground" : "text-danger")} />}
                    {resumable && <Clock className={cn("size-3", isSelected ? "text-primary-foreground" : "text-success")} />}
                  </div>
                </div>
              </button>
            );
