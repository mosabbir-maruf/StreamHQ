            ...
            {chunks.map((subarray, colIndex) => (
              <motion.div
                ...
                transition={{
                  ...
                  repeatType: "reverse",
                  duration: mobile 
                    ? (colIndex % 2 === 0 ? 20 : 30) // Slower on mobile to reduce GPU load
                    : (colIndex % 2 === 0 ? 10 : 15), // Original speed on desktop
                }}
              >
                ...
                {subarray.map((image, imageIndex) => (
                  <div className="relative" key={imageIndex + image}>
                    ...
                    <motion.img
                      ...
                      whileHover={mobile ? {} : { // Disable hover effects on mobile
                        y: -40,
                      }}
                      transition={{
                        duration: mobile ? 0.1 : 0.3, // Faster transitions on mobile
                        ease: "easeInOut",
                      }}
                      className={cn(
